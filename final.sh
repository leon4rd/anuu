...
time rclone copy /tmp/cirrus-ci-build/rom/out/target/product/onclite/Nusantara*.zip drv:onclite/nad/12/ -P
...
curl -s https://api.telegram.org/$tokentl/sendMessage -d chat_id=$idtl -d text="Download link https://crimson-sunset-175c.chestereckhart2871.workers.dev/0:/onclite/nad/12/$(cd /tmp/cirrus-ci-build/rom/out/target/product/onclite && ls Nusantara*.zip))"
